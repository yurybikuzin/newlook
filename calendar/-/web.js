        ...
        $$.$nl_calendar_demo = (rootElem) => {
            ...
            return new $$.$me_atom2_elem({ tail: 'app', cnf: {
                    ...
                    prop: {
                        demoFor: () => '$nl_calendar',
                        defs: () => ({
                            leftTop: Object.assign({}, defaults),
                            rightTop: Object.assign({}, defaults, { k: () => 1.5 }),
                            leftBottom: Object.assign({}, defaults, { k: () => 2 }),
                            rightBottom: Object.assign({}, defaults, { k: () => .75 }),
                        }),
                    },
                    style: {
