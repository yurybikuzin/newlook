            ...
            elem: useControl ? null : {
                option: $$.$me_atom2_prop({ keys: ['.option_ids'] }, ({ key: [id] }) => ({
                    ...
                    style: {
                        ...
                        paddingTop: () => 5,
                        borderTop: $$.$me_atom2_prop(['.isSelected'], ({ masters: [isSelected] }) => isSelected ? '1px solid #008ecf' : '1px solid #bdc3d1'),
                        borderBottom: $$.$me_atom2_prop(['.isSelected'], ({ masters: [isSelected] }) => isSelected ? '1px solid #008ecf' : '1px solid #bdc3d1'),
                        borderLeft: $$.$me_atom2_prop(['.isSelected', '.idx', '<.idx'], ({ masters: [isSelected, idx, idx_selected] }) => isSelected ? '1px solid #008ecf' : !idx || idx == 2 && !idx_selected ? '1px solid #bdc3d1' : ''),
                        borderRight: $$.$me_atom2_prop(['.isSelected', '.idx', '<.idx'], ({ masters: [isSelected, idx, idx_selected] }) => isSelected ? '1px solid #008ecf' : idx == 2 || !idx && idx_selected == 2 ? '1px solid #bdc3d1' : ''),
                        borderTopLeftRadius: $$.$me_atom2_prop(['.idx'], ({ masters: [idx] }) => idx ? '' : '4px'),
                        borderBottomLeftRadius: $$.$me_atom2_prop(['.idx'], ({ masters: [idx] }) => idx ? '' : '4px'),
                        borderTopRightRadius: $$.$me_atom2_prop(['.idx'], ({ masters: [idx] }) => idx != 2 ? '' : '4px'),
                        borderBottomRightRadius: $$.$me_atom2_prop(['.idx'], ({ masters: [idx] }) => idx != 2 ? '' : '4px'),
                        whiteSpace: () => 'nowrap',
                        paddingLeft: () => 8,
                        paddingRight: () => 8,
                    },
...
(function ($) {
    ...
    (function ($$) {
        ...
        const defaults = {
            value: $$.$me_atom2_prop([], () => '0', ({ val, atom }) => console.log(atom.name(), val)),
        };
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//demo.js.map
